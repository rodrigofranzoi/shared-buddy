...
PAINT_FEATURES = {
    "history": {
        "titles": {
            ...
            "fr": "Historique et favoris",
            "it": "Cronologia e preferiti",
            "ar": "السجل والمفضلات",
            "zh": "历史与收藏",
            "ru": "История и избранное",
            "ja": "履歴とお気に入り",
        },
        "descs": {
            ...
            "fr": "Les couleurs du presse-papiers rejoignent l’Historique — passez aux Favoris pour les épingler.",
            "it": "I colori dagli appunti finiscono in Cronologia — passa ai Preferiti per i campioni fissi.",
            "ar": "ألوان الحافظة في السجل — انتقل إلى المفضلات للعينات المثبتة.",
            "zh": "剪贴板颜色进入历史——切换到收藏查看固定色块。",
            "ru": "Цвета из буфера — в Истории. Переключайтесь на Избранное для закреплённых образцов.",
            "ja": "クリップボードの色は履歴へ。固定したい色はお気に入りへ。",
        },
        "ui": {},
    },
    "detail": {
        "titles": {
            ...
            "fr": "Copiez chaque canal",
            "it": "Copia ogni canale",
            "ar": "انسخ أي قناة",
            "zh": "逐通道复制",
            "ru": "Копируйте каналы",
            "ja": "チャンネルごとにコピー",
    ...
    "palette": {
        "titles": {
            ...
            "fr": "Historique flottant",
            "it": "Cronologia flottante",
            "ar": "سجل عائم",
            "zh": "浮动历史",
            "ru": "Плавающая история",
            "ja": "フローティング履歴",
        },
        "descs": {
            ...
            "fr": "Gardez les pastilles récentes au premier plan — grille, liste ou détaillé avec canaux.",
            "it": "Tieni i campioni recenti in primo piano — griglia, elenco o dettagliato con canali.",
            "ar": "أبقِ العينات الأخيرة في المقدمة — شبكة أو قائمة أو تفصيلي مع القنوات.",
            "zh": "最近色块始终置顶——网格、列表或带通道芯片的详细视图。",
            "ru": "Недавние образцы всегда сверху — сетка, список или подробный вид с каналами.",
            "ja": "最近のスウォッチを常に前面に。グリッド / リスト / 詳細（チャンネル付き）。",
        },
        "ui": {},
    },
    "favorites": {
        "titles": {
            ...
            "fr": "Favoris flottants",
            "it": "Preferiti flottanti",
            "ar": "مفضلات عائمة",
            "zh": "浮动收藏",
            "ru": "Плавающее избранное",
            "ja": "フローティングお気に入り",
        },
        "descs": {
            ...
            "fr": "Un second panneau toujours au premier plan pour les couleurs épinglées du quotidien.",
            "it": "Un secondo pannello sempre in primo piano solo per i colori preferiti di ogni giorno.",
            "ar": "لوحة ثانية دائمًا في المقدمة لألوانك المفضلة التي تعيد استخدامها.",
            "zh": "第二个始终置顶面板，专放整天复用的收藏色。",
            "ru": "Вторая панель поверх окон — только для избранных цветов на весь день.",
            "ja": "一日中使うお気に入り専用の、もう一つの常時前面パネル。",
        },
        "ui": {},
    },
    "formats": {
        ...
        "descs": {
            ...
            "fr": "Choisissez les formats à enregistrer et le format de copie — y compris hex sans #.",
            "it": "Scegli quali formati salvare e come formattare i colori — anche hex senza #.",
            "ar": "اختر التنسيقات المحفوظة وتنسيق النسخ — بما في ذلك hex بدون #.",
            "zh": "选择要保存的格式，以及复制时的输出格式——包括不带 # 的 hex。",
            "ru": "Выберите, какие форматы сохранять и как копировать — даже hex без #.",
            "ja": "保存する形式とコピー時の書式を選択。# なし hex にも対応。",
        },
        "ui": {},
    },
    "pick": {
        ...
        "descs": {
            ...
            "fr": "Pipette en un clic vers Historique ou Favoris — sans enregistrement d’écran.",
            "it": "Contagocce monouso in Cronologia o Preferiti — nessuna registrazione dello schermo.",
            "ar": "قطارة بنقرة إلى السجل أو المفضلات — دون تسجيل الشاشة.",
            "zh": "一键取色到历史或收藏——无需屏幕录制。",
            "ru": "Пипетка в один клик в Историю или Избранное — без записи экрана.",
            "ja": "ワンショットのスポイトで履歴またはお気に入りへ。画面収録は不要。",
        },
        "ui": {},
    },
    "menubar": {
        ...
        "descs": {
            ...
            "fr": "Couleurs récentes en un clic — pipette, Historique, Favoris et pause.",
            "it": "Colori recenti a un clic — contagocce, Cronologia, Preferiti e pausa.",
            "ar": "الألوان الأخيرة بنقرة — قطارة وسجل ومفضلات وإيقاف.",
